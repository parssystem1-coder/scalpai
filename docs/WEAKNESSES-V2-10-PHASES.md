...
- [ ] فاز ۱۰: کیفیت محصول، مستندات و حذف بدهی فنی (در جریان — batch 1 با ADR-0043 ده مورد و batch 2 با ADR-0044 سه مورد را بست؛ M19، M5، M5b، M5c، M14، M15 بسته شدند؛ باز: M1، L1/W01/W22/W23، L2)
