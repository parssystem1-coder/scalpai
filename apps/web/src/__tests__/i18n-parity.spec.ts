...
const M5_SOURCES: string[] = [
  ...
  // M5c components
  join(WEB_SRC, "components", "modals", "ConsentCertificateModal.tsx"),
  join(WEB_SRC, "components", "modals", "GuidedCaptureModal.tsx"),
  join(WEB_SRC, "components", "modals", "LicenseDiagnosticsModal.tsx"),
  join(WEB_SRC, "components", "ScalpMap.tsx"),
  join(WEB_SRC, "components", "modals", "SyncInspectorModal.tsx"),
