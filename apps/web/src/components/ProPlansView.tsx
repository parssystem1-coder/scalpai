...
export const ProPlansView: React.FC<ProPlansViewProps> = ({ onSelectPlan }) => {
  ...
  return (
    <div className="animate-fadeIn">
      <h1 className="font-serif text-3xl font-normal mb-1">{t("dashboard.proPlans.title")}</h1>
      <p className="text-xs font-light text-[oklch(42%_0.02_20)] mb-4">
        {t("dashboard.proPlans.plan1Desc")}
      </p>
      ...
      <div className="flex items-baseline justify-between p-3 rounded-2xl bg-gradient-to-r from-[oklch(85%_0.12_55/0.2)] to-[oklch(76%_0.085_24/0.15)] border border-[oklch(85%_0.12_55/0.4)] mb-3.5">
        <span className="text-xs font-semibold text-[oklch(20%_0.02_20)]">{t("dashboard.proPlans.plan1Title")}</span>
      ...
      <div className="space-y-2.5 mb-5" dir="rtl">
        <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-white/40 border border-white/60">
          ...
          <div>
            <strong className="text-xs block text-[oklch(20%_0.02_20)]">{t("dashboard.proPlans.plan1Title")}</strong>
        ...
        <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-white/40 border border-white/60">
          ...
          <div>
            <strong className="text-xs block text-[oklch(20%_0.02_20)]">{t("dashboard.proPlans.plan2Title")}</strong>
            <p className="text-[0.7rem] text-[oklch(42%_0.02_20)] mt-0.5 leading-relaxed">
              {t("dashboard.proPlans.plan2Desc")}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2.5 p-2.5 rounded-xl bg-white/40 border border-white/60">
          ...
          <div>
            <strong className="text-xs block text-[oklch(20%_0.02_20)]">{t("dashboard.proPlans.plan3Title")}</strong>
            <p className="text-[0.7rem] text-[oklch(42%_0.02_20)] mt-0.5 leading-relaxed">
              {t("dashboard.proPlans.plan3Desc")}
            </p>
          </div>
        </div>
      </div>
      ...
      >
        {t("dashboard.proPlans.plan1Title")}
      </button>
    </div>
  );
};
