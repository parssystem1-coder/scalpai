...
> **این گیت مرحله اجباری پایان هر فاز است، نه اختیاری.** scalpai-build موظف است پس از اتمام تسک‌ها آن را درخواست کند؛ فاز بدون حکم PASS این‌جا «تمام» نیست.
...
- تنها فایل‌هایی که حق نوشتن داری: خودِ گزارش گیت + یک خط حکم در PROGRESS.md
...
10. **پس از PASS:** یک خط حکم به بخش فاز در `docs/PROGRESS.md` اضافه کن: `> 🔒 Gate: PASS — YYYY-MM-DD — docs/gates/GATE_REVIEW_phase-N-....md` و کامیت کن
